      ...
      <div className="container px-4 mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-4 space-y-8">
            {/* Contact Card */}
            <div className="card-hover-effect glow-border bg-card p-6 rounded-lg border border-primary/20 shadow-lg hover:shadow-primary/5 transition-all duration-300">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">Sangli-Maharashtra, INDIA</p>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400"> (Not available yet)</p>
            ...
            <div className="card-hover-effect glow-border bg-card p-6 rounded-lg border border-primary/20 hover:border-primary/40 transition-all duration-300">
              <h4 className="font-medium text-lg mb-2 flex items-center gap-2">
                <Clock className="text-primary h-5 w-5" /> Response Time
              </h4>
              <p className="text-gray-400">
                I typically respond to all inquiries within 24-72 hours. For urgent security matters, 
            ...
            <div className="card-hover-effect glow-border bg-card p-6 rounded-lg border border-primary/20 hover:border-primary/40 transition-all duration-300">
              <h4 className="font-medium text-lg mb-3 flex items-center gap-2">
                <CheckSquare className="text-primary h-5 w-5" /> I can do 
              </h4>
              <ul className="space-y-2">
                ...
                <li className="flex items-start gap-2">
                  ...
                  <span className="text-gray-400">Bug Bounty Hunting </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="rounded-full bg-primary/20 p-1 mt-0.5">
                    <div className="w-2 h-2 rounded-full bg-primary"></div>
                  </div>
                  <span className="text-gray-400">Security Research Collaborations</span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="rounded-full bg-primary/20 p-1 mt-0.5">
                    <div className="w-2 h-2 rounded-full bg-primary"></div>
                  </div>
                  <span className="text-gray-400">CTF Collaborations</span>
                </li>
              </ul>
            </div>
          </div>
